...
Visual:
Background: var(--sidebar-background)  -> #f8fafc  (separate navigation layer)
border-right: 1px solid var(--sidebar-border)  -> #d9e1ea
No heavy shadow

Active navigation:
background: var(--nav-active-background) -> #e8f1fc
color: var(--nav-active-text) -> var(--primary)
Do NOT use a strong blue fill for the entire navigation.
